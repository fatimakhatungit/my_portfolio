        ...
        <div className="row">
            ...
            <article className="col-12">
                ...
                <div className="meta open-sans-font">
                    <span><i className="fa fa-user"></i> steve</span>
                    <span className="date"><i className="fa fa-calendar"></i> 9 January 2017</span>
                ...
                <img src="img/blog/blog-post-1.jpg" className="img-fluid" alt="Blog image"/>
